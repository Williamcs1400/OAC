...
#############################									  ###########################################################
#############################   Nome: Douglas Samuel Thomazi Azevedo	Matricula: 18/0119109	  ###########################################################
#############################   Nome: Matheus Arruda Aguiar 		Matricula: 18/0127659 	  ###########################################################
#############################   Nome: William Coelho da Silva	 	Matricula: 18/0029274	  ###########################################################
#############################									  ###########################################################
#############################################################################################################################################################
#############################################################################################################################################################
#############################################################################################################################################################
...
INICIO:
	...
	##############################
	## Testando se eh igual a 7 ##
	##############################
	addi t0, x0, 7
	beq a0, t0, CARREGA_IMAGEM			#if(a0 == 7) PC = CARREGA_IMAGEM
...
CARREGA_IMAGEM:	
	...
	load_image:
		...
		# parametros da chamada de sistema: a7=1024, a0=string com o direcionario da imagem, a1 = definicaoo de leitura/escrita
		li a7, 1024				# chamada de sistema para abertura de arquivo
		li a1, 0				# Abre arquivo para leitura (pode ser 0: leitura, 1: escrita)
		ecall					# Abre um arquivo (descritor do arquivo ao retornado em a0)
	...
	loop:  
		...
		#parametros da chamada de sistema: a7=63, a0=descritor do arquivo, a1 = endereço do buffer, a2 = maximo tamanho pra ler
...
################################################################################
################################################################################
#### 	Funcao ObtemPonto: Carrega uma cordenada do bitmap no registrador   ####
####		 	   e mostar o valor em decimal da cor no terminal   ####
####								     	    ####
####  	Parametros:							    ####
...
################################################################################
################################################################################
#### 	Funcao ReganguloComPreenchimento: Carrega as cordenadas x0, x1,     #### 
####					  y0, y1 e a cor e desenha  um      ####
####					  regangulo completo no bitmap      ####
####									    ####
####	Parametros:							    ####
...
################################################################################
################################################################################
####    Funcao ReganguloSemPreenchimento: Carrega as cordenadas x0, x1,	    ####
####					  y0, y1 e a cor e desenha as       ####
####					  bordas de um retangulo no bitmap  ####
####									    ####
####	Parametros:							    ####
#### 		t0 : Valor de X1 digitado pelo o usuario		    ####
#### 		t1 : Valor de Y1 digitado pelo o usuario                    ####
...
################################################################################
################################################################################
####	Função NEGATIVA_IMAGEM: Carrega o RGB de um endereço 		    ####
####				no Bitmap e subtrai cada cor                ####
####				por 255 e a coloca no Bitmap		    ####
####								 	    ####
####	Registradores:							    ####
...
################################################################################
################################################################################
####	Função IMAGEM_VERMELHA: Carrega o RGB de um endereço no Bitmap,      ###
####                            coloca o valor 00 no GB e a coloca no Bitmap ###
####									     ###
####	Registradores:							     ###
####		s3: Valor total de todos os pontos no Bitmap, 64*64          ###
####		s4: contador para parar quando chegar em 4096                ###
...
################################################################################	
################################################################################
####   Funcao que identifica se o usuario inseriu valor fora do esperado    ####
################################################################################
################################################################################
...
################################################################################	
################################################################################
####   Funcao que identifica se o usuario inseriu valores fora do esperado  ####
################################################################################
################################################################################
...
################################################################################
################################################################################
#### Funcao Le X e Y composto: Le apenas x1, y1, x2, y2 e armazena em       ####
####			       t0, t1, s10 e s1				    ####
################################################################################
################################################################################
